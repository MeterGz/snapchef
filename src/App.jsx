  ...
  return (
    <div className={`min-h-screen transition-colors duration-300 ${darkMode ? 'dark-glass' : 'light-warm'}`} style={{position:'relative',overflowX:'hidden', background: rootBg}}>
      ...
      <style>{`
        ...
        .shadow-red-500\\/20 { --tw-shadow-color: rgba(239,68,68,0.2); box-shadow: 0 10px 15px -3px var(--tw-shadow-color), 0 4px 6px -4px var(--tw-shadow-color); }
        .shadow-emerald-500\\/20 { --tw-shadow-color: rgba(16,185,129,0.2); box-shadow: 0 10px 15px -3px var(--tw-shadow-color), 0 4px 6px -4px var(--tw-shadow-color); }
        ...
        /* === END UTILITY CLASS FALLBACKS === */
        /* === ADDITIONAL POSITION/LAYOUT UTILITIES === */
